...
const generateCSS = (props: any) => {
  ...
  const stepNames = ["xs", "sm", "md", "lg", "xl", "2xl", "3xl", "4xl", "5xl"];
...
export const ConnectView = () => {
  ...
  const handleSync = () => {
    ...
    const headingStyles = ["H1", "H2", "H3", "H4", "H5", "H6"].map((h, i) => {
    ...
    <div className="h-full flex flex-col overflow-hidden">
      <header className="p-6 border-b border-glass-stroke bg-bg-void/50 backdrop-blur-sm flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400 text-sm">Design-to-Code Pipeline</p>
        </div>
      ...
      <div className="flex-1 overflow-hidden p-6 relative">
        <AnimatePresence mode="wait">
            ...
            >
              <div className="relative">
                ...
                <div className="relative z-10 w-24 h-24 bg-bg-raised border border-glass-stroke rounded-2xl flex items-center justify-center shadow-2xl">
                  <div className="w-12 h-12 bg-[#F24E1E] rounded-xl flex items-center justify-center">
                    ...
                    <span className="font-brand text-white text-2xl">Fi</span>
                  </div>
                </div>
                {/* Connector Line */}
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-400">
                  Push your <b>Global Design System</b> and <b>Collections</b>{" "}
                  to the active Figma file. This will create or update variables
              ...
              <div className="p-4 rounded-lg bg-bg-raised/50 border border-white/5 text-left w-full">
                ...
                <ul className="text-xs text-gray-400 space-y-1">
                  <li className="flex items-center gap-2">
                    ...
                    Global Color Ramps (Primary, Secondary...)
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-cyan rounded-full" />{" "}
                    Typography Scale ({ctx.scale?.name || "Scale"})
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-accent-cyan rounded-full" />{" "}
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    {ctx.settings?.library?.collections?.length || 0} Custom
                    Collections
                  </li>
                </ul>
              </div>
          ...
          {activeTab === "export" && (
            <div key="export" className="h-full flex flex-col gap-6">
