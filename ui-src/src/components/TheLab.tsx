    ...
    <div className="h-full flex flex-col gap-6">
      ...
      <div className="flex-1 bg-bg-surface/30 rounded-2xl border border-glass-stroke p-0 relative overflow-hidden backdrop-blur-sm shadow-monolith">
        ...
        <AnimatePresence mode="wait">
          {activeTab === "generator" && (
            <PaletteGenerator key="generator" onSavePalette={savePalette} />
          )}
          {activeTab === "contrast" && (
  ...
  return (
    <div className="h-full flex flex-row gap-8">
      ...
      <div className="w-1/3 flex flex-col gap-6 p-6 bg-black/20 rounded-xl border border-glass-stroke">
        <h3 className="text-white font-brand text-lg mb-2">Parameters</h3>
      ...
      <div className="flex-1 rounded-2xl flex flex-col items-center justify-center p-12 transition-colors duration-200 shadow-inner relative overflow-hidden">
        ...
        <div ref={textRef} className="space-y-8 text-center text-dynamic">
        ...
        <div className="flex gap-4 mt-auto">
          ...
          <div className="p-2 rounded-lg border border-transparent hover:border-glass-stroke transition-all">
            <HeartToggle
              ...
              size={16}
              className={isFavorite ? "scale-110" : "hover:scale-110"}
            />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="space-y-4 font-body-dynamic">
          <p className="text-lg leading-relaxed opacity-80 max-w-xl">
            Good typography is invisible. It allows the reader to focus on the
            content, not the formatting.
          </p>
          <p className="text-sm opacity-60 max-w-lg">
            Use modular scales to ensure harmony between your headings and body
            text. A well-chosen pair can define your entire brand aesthetic.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="space-y-12">
        ...
        <div className="space-y-4">
          ...
          {library.palettes.length === 0 ? (
            <p className="text-gray-600 text-xs italic">No saved palettes.</p>
          ) : (
              ...
              {library.palettes.map((p: any, i: number) => (
                ...
                >
                  ...
                  <div className="flex justify-end">
                    <button
                      onClick={() => onLoadColor(p.colors[0])} // Just load first color for now as seed?
        ...
        <div className="space-y-4">
          ...
          {library.fonts.length === 0 ? (
            <p className="text-gray-600 text-xs italic">No saved pairings.</p>
          ) : (
        ...
        <div className="space-y-4">
          ...
          {library.colors.length === 0 ? (
            <p className="text-gray-600 italic text-sm">No saved colors yet.</p>
          ) : (
