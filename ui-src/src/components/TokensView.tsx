  ...
  const handleSync = () => {
    if (activeModule === "colors") {
      ...
      const styles = levels.map((l) => ({
        name: l.name,
        fontSize: Number((baseSize * Math.pow(scale.ratio, l.step)).toFixed(2)),
        lineHeight: 1.2,
      }));
    ...
    <div className="grid grid-cols-12 gap-8 h-full">
      <div className="col-span-12 lg:col-span-8 flex flex-col">
        <div className="flex items-center gap-4 mb-6">
          <h2 className="font-brand text-2xl text-white">Design Tokens</h2>
              ...
              {activeModule === "colors" && (
                <>
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="font-brand text-lg text-white">Colors</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-2 border-b border-glass-stroke pb-0 mb-4 overflow-x-auto">
                      {[
                        ...
                        <button
                          key={step}
                          onClick={() => setActiveColorStep(step as any)}
              ...
              {activeModule === "typography" && (
                <>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={onNavigateToTypeAtelier}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-gray-500 mb-6 min-h-[40px]">
              ...
              {activeModule === "typography" && `7 text styles ready to sync.`}
              {activeModule === "spacing" && `9 spacing tokens ready to sync.`}
              {activeModule === "semantics" &&
